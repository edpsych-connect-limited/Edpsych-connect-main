...
export class SystemMetricsCollector {
  ...
  async collectAndPublishMetrics(): Promise<void> {
    try {
      ...
      console.error('Error collecting system metrics:', _error);
    }
  }
  ...
  private async getCpuUsage(): Promise<number | null> {
    ...
    try {
      ...
      console.error('Error calculating CPU usage from os module:', _error);
  ...
  private async getDiskUsage(): Promise<number | null> {
    try {
      ...
      console.error('Error calculating disk usage:', _error);
    }
