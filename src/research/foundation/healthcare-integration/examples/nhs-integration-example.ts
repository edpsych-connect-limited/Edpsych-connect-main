...
async function runNHSDigitalIntegrationExample() {
  ...
  try {
    ...
    try {
      ...
      console.error('Error creating observation:', _error);
    ...
    try {
      ...
      console.error('Error fetching NHS patient demographics:', _error);
