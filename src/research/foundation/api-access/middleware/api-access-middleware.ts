...
export const verifyApiKey = () => {
  ...
  return async (req: ApiAccessRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      console.error('API key verification error:', _error);
      res.status(500).json({
        success: false,
...
export const checkApiQuota = (
  ...
  return async (req: ApiAccessRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      console.error('API quota check error:', _error);
      res.status(500).json({
        success: false,
  ...
  return async (req: ApiAccessRequest, res: Response, next: NextFunction): Promise<void> => {
    ...
    res.end = function(this: Response, ...args: any[]): Response {
      ...
      try {
        ...
        console.error('Error tracking API usage:', _error);
      }
...
export const setRateLimitHeaders = () => {
  ...
  return async (req: ApiAccessRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      console.error('Error setting rate limit headers:', _error);
      next();
      return;
    }
  };
...
export const apiAccessControl = (options: {
  ...
  return async (req: ApiAccessRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      console.error('API access control error:', _error);
      res.status(500).json({
        success: false,
