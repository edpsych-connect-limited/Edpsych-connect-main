...
router.get('/pricing-plans',
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Get pricing plans error:', _error);
...
router.get('/pricing-plans/:id',
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Get pricing plan error:', _error);
      return res.status(500).json({
        success: false,
...
router.post('/keys', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Create API key error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/keys',
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Get API keys error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/keys/:id', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Get API key error:', _error);
      return res.status(500).json({
        success: false,
...
router.put('/keys/:id', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Update API key error:', _error);
      return res.status(500).json({
        success: false,
...
router.post('/keys/:id/deactivate', 
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Deactivate API key error:', _error);
      return res.status(500).json({
        success: false,
...
router.post('/keys/:id/rotate', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Rotate API key error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/usage', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Get usage summary error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/usage/report', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Generate usage report error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/quotas',
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Get quota consumption error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/alerts', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Get usage alerts error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/billing/invoice', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Generate invoice error:', _error);
      return res.status(500).json({
        success: false,
