...
router.post('/licenses', async (req: Request, res: Response) => {
  try {
    ...
    console.error('Create license error:', _error);
...
router.post('/licenses/validate', async (req: Request, res: Response) => {
  try {
    ...
    console.error('Validate license error:', _error);
    return res.status(500).json({
      success: false,
...
router.get('/licenses/:id', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Get license error:', _error);
      return res.status(500).json({
        success: false,
...
router.put('/licenses/:id', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Update license error:', _error);
      return res.status(500).json({
        success: false,
...
router.post('/licenses/:id/deactivate', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Deactivate license error:', _error);
      return res.status(500).json({
        success: false,
...
router.post('/licenses/:id/renew', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Renew license error:', _error);
      return res.status(500).json({
        success: false,
...
router.post('/licenses/:id/upgrade', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Upgrade license error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/organizations/:organizationId/licenses', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Get organization licenses error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/licenses/report', 
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Generate license report error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/research/data', 
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Research data access error:', _error);
      return res.status(500).json({
        success: false,
...
router.post('/research/ml/run', 
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Run machine learning model error:', _error);
      return res.status(500).json({
        success: false,
...
router.get('/research/nhs-digital/data', 
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('NHS Digital data access error:', _error);
      return res.status(500).json({
        success: false,
...
router.post('/research/data/export', 
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Export research data error:', _error);
      return res.status(500).json({
        success: false,
...
router.post('/research/ai/train', 
  ...
  async (_req: Request, res: Response) => {
    try {
      ...
      console.error('Train custom AI model error:', _error);
      return res.status(500).json({
        success: false,
