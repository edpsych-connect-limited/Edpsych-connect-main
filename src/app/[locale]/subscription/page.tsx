...
export default function SubscriptionManagementPage() {
  ...
  const loadSubscriptionData = async () => {
    try {
      ...
      console.error('Failed to load subscription data:', _error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleCancelSubscription = async () => {
    ...
    try {
      ...
      console.error('Failed to cancel subscription:', _error);
  ...
  const handleReactivateSubscription = async () => {
    try {
      ...
      console.error('Failed to reactivate subscription:', _error);
