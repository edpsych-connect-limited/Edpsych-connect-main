...
export default function MasterclassTrainingAcademy() {
  ...
  if (authLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50" role="status" aria-live="polite">
        <div className="text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-b-4 border-blue-600 mx-auto mb-4"></div>
          <p className="text-gray-600 font-medium">Loading Academy...</p>
        </div>
        <span className="sr-only">Loading training academy...</span>
      </div>
    );
  }
