    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-start" data-tour="ehcp-header">
            ...
            <div className="flex space-x-3">
              <button
                type="button"
                onClick={() => startTour('ehcp-detail')}
                className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100"
              >
                Take Tour
              </button>
              <button
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-blue-800">
                Review status and key dates before editing. Capture evidence updates in the relevant
                section, then export once all sections are validated.
              </p>
            </div>
            <div className="text-xs text-blue-700">
              Focus: status, evidence, export.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-3">
            <nav className="bg-white rounded-lg shadow p-4 sticky top-4" data-tour="ehcp-sections">
          ...
          <div className="col-span-9">
            <div className="bg-white rounded-lg shadow p-6" data-tour="ehcp-content">
              {/* Overview */}
