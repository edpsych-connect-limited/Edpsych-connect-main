  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-blue-900">
                Schedule the next assessment to keep cases moving while evidence is fresh.
              </p>
            </div>
            <Link
        ...
        {/* Loading State */}
        {loading ? (
          <div className="bg-white shadow rounded-lg p-12" role="status" aria-live="polite">
          ...
          <EmptyState
            ...
            description="Get started by scheduling a new assessment for a student. You can choose from various assessment types including Cognitive, Educational, and Behavioural."
            icon={<Brain className="w-8 h-8 text-blue-500" />}
            actionLabel="Schedule Assessment"
            actionHref="/assessments/new"
            secondaryActionLabel="View Assessment Guide"
            secondaryActionHref="/help/assessments"
          />
        ) : (
          /* Assessment List */
          <>
            <div className="bg-white shadow rounded-lg overflow-hidden">
              <table className="min-w-full divide-y divide-gray-200" aria-label="Assessments list">
