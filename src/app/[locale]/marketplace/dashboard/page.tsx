        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-blue-800">
              Review pending bookings first, then check earnings and profile status. Keep availability
              accurate to improve match quality.
            </p>
          </div>
          <div className="text-xs text-blue-700">
            Focus: pending requests, availability, earnings.
          </div>
        </div>
      </div>
