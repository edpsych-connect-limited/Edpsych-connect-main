...
export default function ClientLayout({
  ...
  return (
    <body className={`min-h-screen ${useMinimalChrome ? 'bg-slate-950' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[9999] focus:px-4 focus:py-2 focus:bg-indigo-600 focus:text-white focus:rounded-lg focus:font-medium focus:text-sm focus:shadow-lg"
      >
