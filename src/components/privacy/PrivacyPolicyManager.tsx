...
export const PrivacyPolicyManager: React.FC = () => {
  ...
  const loadPrivacyData = async () => {
    try {
      ...
      console.error('Failed to load privacy data', _error instanceof Error ? _error : new Error(String(_error)));
  ...
  const handleConsentChange = async (consentTypeId: string, consented: boolean) => {
    try {
      ...
      console.error('Failed to update consent', _error instanceof Error ? _error : new Error(String(_error)), { consentTypeId, consented });
  ...
  const handleDataExport = async () => {
    try {
      ...
      console.error('Failed to export data', _error instanceof Error ? _error : new Error(String(_error)));
  ...
  const handleDataDeletion = async () => {
    ...
    try {
      ...
      console.error('Failed to submit deletion request', _error instanceof Error ? _error : new Error(String(_error)));
