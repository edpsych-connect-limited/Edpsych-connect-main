                  ...
                  {expandedBio && (
                    ...
                    >
                      ...
                      <div className="mb-6">
                        ...
                        <p className="text-slate-600 text-sm leading-relaxed mb-3">
                          As <strong>Senior Educational Psychologist at Buckinghamshire Council</strong> (until 2023), Dr Ighavongbe-Patrick created <strong>TEAM-UP</strong> (Termly Early Action Multi-Agency Unified Planning)—a pioneering multi-agency early intervention initiative. This project addressed systemic delays in supporting children with complex needs by fostering collaboration between agencies and school SENCOs, shifting the paradigm from reactive crisis management to proactive, timely support.
                        </p>
                        <p className="text-slate-600 text-sm leading-relaxed mb-3">
