...
// Export interface for gamification functionality
// Using a new name to avoid any potential collision or caching issues
export const GamificationInterface = {
...
export const GamificationAPI = GamificationInterface;