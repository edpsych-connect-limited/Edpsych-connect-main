...
// ========================================================================
// TRAUMA & ATTACHMENT INTERVENTIONS (Ingested)
// ========================================================================
BEHAVIORAL_INTERVENTIONS.push(
  {
    id: 'trauma-iceberg-model',
    name: 'The Iceberg Model of Behaviour',
    category: 'behavioural',
    subcategory: 'trauma_informed',
    description: 'A framework for understanding behaviour as a symptom of underlying unmet needs (safety, connection, regulation). Shifts focus from "What is wrong with you?" to "What happened to you?".',
    targeted_needs: ['Trauma responses', 'Fight/Flight/Freeze', 'Emotional dysregulation', 'Challenging behaviour'],
    evidence_level: 'tier_1',
    research_sources: ['Bessel van der Kolk', 'Stephen Porges', 'Trauma Informed Schools UK'],
    age_range: ['all'],
    setting: ['mixed'],
    duration: 'Ongoing',
    frequency: 'Daily',
    ...
    complexity: 'medium',
    staff_training_required: true,
    resources_needed: ['Iceberg Visual', 'Staff Training'],
    cost_implications: 'Staff training costs',
    key_components: ['Curiosity not judgement', 'Safety first', 'Connection before correction'],
    fidelity_checklist: ['Staff use trauma-informed language', 'Safe spaces available'],
    progress_indicators: ['Reduction in exclusions', 'Increased student engagement'],
    expected_outcomes: ['Felt safety', 'Reduced hypervigilance'],
    adaptations: ['Visual icebergs for students'],
    contraindications: ['Punitive behaviour policies'],
    complementary_interventions: ['Key Person', 'Safe Space'],
    implementation_guide: 'When a student "flips their lid", do not sanction immediately. Ask: What is the behaviour communicating? Is it a safety need? A connection need? Address the bottom of the iceberg.',
    parent_information: 'We look beyond the behaviour to see what your child needs. We know that angry outbursts often mean "I feel unsafe" or "I am overwhelmed".',
    useful_links: ['https://www.traumainformedschools.co.uk'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['trauma', 'behaviour', 'iceberg', 'tier_1']
  }
);

SOCIAL_EMOTIONAL_INTERVENTIONS.push(
  {
    id: 'attachment-key-person',
    name: 'The Key Person Approach (Secondary)',
    category: 'social_emotional',
    subcategory: 'attachment',
    ...
    duration: 'Long term',
    frequency: 'Daily check-ins',
    session_length: '10 mins',
    complexity: 'medium',
    staff_training_required: true,
    resources_needed: ['Time allocation'],
    cost_implications: 'Staff time',
    key_components: ['Meet and Greet', 'Emotional Check-in', 'Secure Base'],
    fidelity_checklist: ['Daily contact made', 'Relationship is prioritized'],
    progress_indicators: ['Student seeks Key Person when distressed', 'Improved attendance'],
    expected_outcomes: ['Increased trust', 'Better emotional regulation'],
    adaptations: ['Check-in via email for avoidant attachment'],
    contraindications: ['Inconsistent staff member'],
    complementary_interventions: ['Trauma Informed Practice'],
    implementation_guide: 'Select a staff member the student likes. Schedule a 5-minute meet and greet every morning. "I am glad you are here." No demands, just connection.',
    parent_information: 'Your child has a named person at school who is their "champion". They will check in every day to make sure they are okay.',
    useful_links: ['https://www.attachment.org'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['attachment', 'key_person', 'relationship', 'tier_2']
  }
);

// ========================================================================
// RESTORATIVE JUSTICE INTERVENTIONS (Ingested)
// ========================================================================
BEHAVIORAL_INTERVENTIONS.push(
  {
    id: 'rj-restorative-chat',
    name: 'Restorative Chat (5 Magic Questions)',
    category: 'behavioural',
    subcategory: 'restorative_justice',
    description: 'A scripted conversation to resolve conflict and repair harm. Moves away from "Who is to blame?" to "Who has been affected?".',
    targeted_needs: ['Conflict', 'Low level disruption', 'Peer arguments'],
    evidence_level: 'tier_1',
    research_sources: ['Restorative Justice Council', 'Thorsborne & Blood'],
    age_range: ['all'],
    setting: ['mixed'],
    duration: '5-10 mins',
    frequency: 'As needed',
    ...
    complexity: 'low',
    staff_training_required: true,
    resources_needed: ['Restorative Script Card'],
    cost_implications: 'None',
    key_components: ['Non-judgmental listening', 'Focus on impact', 'Repairing harm'],
    fidelity_checklist: ['Used 5 questions', 'Both sides heard'],
    progress_indicators: ['Students resolve own conflicts', 'Reduced repeat incidents'],
    expected_outcomes: ['Empathy development', 'Conflict resolution skills'],
    adaptations: ['Visual script for younger children'],
    contraindications: ['When safety is at risk'],
    complementary_interventions: ['Circle Time'],
    implementation_guide: '1. What happened? 2. What were you thinking? 3. How did you feel? 4. Who has been affected? 5. What do you need to do to make things right?',
    parent_information: 'We teach children to fix their mistakes. Instead of just punishing, we ask them to understand how their actions hurt others and how to make it better.',
    useful_links: ['https://restorativejustice.org.uk'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['restorative', 'behaviour', 'conflict', 'tier_1']
  }
);

SOCIAL_EMOTIONAL_INTERVENTIONS.push(
  {
    id: 'rj-undercover-teams',
    name: 'Undercover Teams (Support Group Method)',
    category: 'social_emotional',
    subcategory: 'bullying',
    description: 'A non-punitive intervention for bullying. A group of students (including the "bully" and bystanders) are tasked with supporting the victim without being blamed.',
    targeted_needs: ['Bullying', 'Social isolation', 'Peer rejection'],
    evidence_level: 'tier_2',
    research_sources: ['Maines & Robinson', '7 Steps to Ending Bullying'],
    age_range: ['primary', 'secondary'],
    setting: ['small_group'],
    duration: '2 weeks',
    frequency: 'Weekly review',
    session_length: '20 mins',
    complexity: 'high',
    staff_training_required: true,
    resources_needed: ['Facilitator'],
    cost_implications: 'Staff time',
    key_components: ['No blame approach', 'Empathy induction', 'Shared responsibility'],
    fidelity_checklist: ['Victim interviewed first', 'Group formed correctly', 'Review meetings held'],
    progress_indicators: ['Victim reports feeling safer', 'Bullying stops'],
    expected_outcomes: ['Social inclusion', 'End of bullying'],
    adaptations: ['N/A'],
    contraindications: ['Criminal assault', 'Severe safety risk'],
    complementary_interventions: ['Restorative Conference'],
    implementation_guide: '1. Interview victim (get feelings). 2. Convene group (bully + bystanders + friends). 3. Explain problem (do not blame). 4. Share feelings. 5. Ask for ideas. 6. Leave it to them. 7. Review in a week.',
    parent_information: 'We are using a special group approach to help your child feel happier at school. We have asked some other students to look out for them.',
    useful_links: ['https://www.anti-bullyingalliance.org.uk'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['bullying', 'restorative', 'social_skills', 'tier_2']
  }
);
...
SOCIAL_EMOTIONAL_INTERVENTIONS.push(
  {
    id: 'pp-perma',
    name: 'PERMA Wellbeing Check-in',
    category: 'social_emotional',
    subcategory: 'wellbeing',
    description: "A framework for assessing and promoting wellbeing based on Seligman's model: Positive Emotion, Engagement, Relationships, Meaning, Accomplishment.",
    targeted_needs: ['Low mood', 'Disengagement', 'Lack of purpose'],
    evidence_level: 'tier_1',
    research_sources: ['Martin Seligman', 'Positive Psychology Center'],
    age_range: ['all'],
    setting: ['mixed'],
    duration: 'Ongoing',
    frequency: 'Weekly',
    ...
    complexity: 'low',
    staff_training_required: false,
    resources_needed: ['PERMA Worksheet'],
    cost_implications: 'None',
    key_components: ['Reflection', 'Goal setting', 'Gratitude'],
    fidelity_checklist: ['All 5 areas covered'],
    progress_indicators: ['Increased self-reported wellbeing'],
    expected_outcomes: ['Flourishing', 'Resilience'],
    adaptations: ['Simplified language for younger children'],
    contraindications: ['Acute mental health crisis (refer to CAMHS)'],
    complementary_interventions: ['Gratitude Journal'],
    implementation_guide: "Use the PERMA acronym to structure a wellbeing conversation. 'What have you enjoyed?' (P), 'What did you get lost in?' (E), 'Who have you connected with?' (R), etc.",
    parent_information: 'We are helping your child focus on what makes life good, not just fixing what is wrong.',
    useful_links: ['https://ppc.sas.upenn.edu'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['wellbeing', 'positive_psychology', 'mental_health', 'tier_1']
  },
  {
    id: 'cof-circle-of-friends',
    name: 'Circle of Friends',
    category: 'social_emotional',
    subcategory: 'social_inclusion',
    description: "A peer-support intervention to help isolated or challenging students build a support network. The 'focus child' is supported by a volunteer circle of peers.",
    targeted_needs: ['Social isolation', 'Peer rejection', 'Challenging behaviour'],
    evidence_level: 'tier_2',
    research_sources: ['Newton & Wilson', 'Inclusive Education research'],
    age_range: ['primary', 'secondary'],
    setting: ['small_group'],
    duration: '6-12 weeks',
    frequency: 'Weekly meetings',
    session_length: '20-30 mins',
    complexity: 'high',
    staff_training_required: true,
    resources_needed: ['Facilitator', 'Meeting space'],
    cost_implications: 'Staff time',
    key_components: ['Whole class meeting (without focus child)', 'Circle formation', 'Weekly problem solving'],
    fidelity_checklist: ['Parent permission obtained', 'Focus child agrees', 'Weekly meetings held'],
    progress_indicators: ['Increased social contact', 'Reduced isolation'],
    expected_outcomes: ['Friendship skills', 'Inclusion'],
    adaptations: ['Circle of Adults for staff support'],
    contraindications: ['If the child refuses'],
    complementary_interventions: ['Social Skills Group'],
    implementation_guide: "1. Gain permissions. 2. Whole class meeting (discuss 'What makes a good friend?', describe focus child's difficulties without naming, ask for volunteers). 3. Form Circle (6-8 peers). 4. Weekly meetings with facilitator to set targets and solve problems.",
    parent_information: 'We are setting up a special group of friends to support your child and help them feel more included at school.',
    useful_links: ['https://inclusive-solutions.com'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['social_skills', 'inclusion', 'peer_support', 'tier_2']
  }
);

ACADEMIC_INTERVENTIONS.push(
  {
    id: 'gm-growth-mindset',
    name: 'Growth Mindset Interventions',
    category: 'academic',
    subcategory: 'metacognition',
    description: "Teaching students that intelligence is malleable and can grow with effort. shifting from 'I can't' to 'I can't YET'.",
    targeted_needs: ['Fear of failure', 'Giving up easily', 'Low academic resilience'],
    evidence_level: 'tier_1',
    research_sources: ['Carol Dweck', 'EEF'],
    age_range: ['all'],
    setting: ['classroom'],
    duration: 'Ongoing',
    frequency: 'Daily language',
    session_length: 'N/A',
    complexity: 'low',
    staff_training_required: true,
    resources_needed: ['Growth Mindset displays'],
    cost_implications: 'None',
    key_components: ['Praising effort not intelligence', 'The Power of Yet', 'Embracing mistakes'],
    fidelity_checklist: ['Staff model growth mindset', 'Feedback focuses on process'],
    progress_indicators: ['Increased persistence', 'Willingness to try hard tasks'],
    expected_outcomes: ['Academic resilience', 'Improved progress'],
    adaptations: ['N/A'],
    contraindications: ['False Growth Mindset (praising effort when no progress is made)'],
    complementary_interventions: ['Metacognition strategies'],
    implementation_guide: "Change feedback language. Instead of 'You are so smart', say 'You worked really hard on that strategy'. Celebrate mistakes as learning opportunities.",
    parent_information: 'We are teaching your child that their brain is like a muscle - it gets stronger when they challenge it.',
    useful_links: ['https://www.mindsetworks.com'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
...
// ========================================================================
// ACADEMIC & COGNITION INTERVENTIONS (Ingested)
// ========================================================================
ACADEMIC_INTERVENTIONS.push(
  {
    id: 'pt-probe',
    name: 'Precision Teaching: 1-Minute Probe',
    category: 'academic',
    subcategory: 'precision_teaching',
    description: "A highly structured, data-driven intervention to build fluency in core skills (reading, spelling, number bonds). Involves daily 1-minute timings and charting progress.",
    targeted_needs: ['Slow processing', 'Lack of fluency', 'Stuck progress'],
    evidence_level: 'tier_3',
    research_sources: ['Lindsley (1990)', 'Haring & Eaton (1978)'],
    age_range: ['all'],
    setting: ['one_to_one'],
    duration: '6-12 weeks',
    ...
    complexity: 'high',
    staff_training_required: true,
    resources_needed: ['Probes', 'Timer', 'Chart'],
    cost_implications: 'Staff time',
    key_components: ['1-minute timing', 'Immediate feedback', 'Charting scores', 'Aiming for fluency (not just accuracy)'],
    fidelity_checklist: ['Daily practice', 'Scores charted', '3 consecutive days of success before moving on'],
    progress_indicators: ['Increased fluency rate (corrects per minute)'],
    expected_outcomes: ['Automaticity', 'Retention'],
    adaptations: ['Digital apps'],
    contraindications: ['High anxiety (if timed pressure is too much)'],
    complementary_interventions: ['Overlearning'],
    implementation_guide: '1. Identify skill. 2. Create probe sheet. 3. Do 1-minute timing. 4. Count corrects and errors. 5. Chart. 6. Review aim line.',
    parent_information: 'We are doing short, daily bursts of practice to help your child learn these facts so well they don\'t have to think about them.',
    useful_links: ['https://precisionteaching.co.uk'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['fluency', 'data', 'academic', 'tier_3']
  },
  {
    id: 'lit-paired-reading',
    name: 'Paired Reading',
    category: 'academic',
    subcategory: 'literacy',
    description: 'A research-based fluency intervention where adult and child read together. The child signals when they want to read alone.',
    targeted_needs: ['Low reading confidence', 'Poor fluency', 'Reluctant readers'],
    evidence_level: 'tier_1',
    research_sources: ['Keith Topping', 'EEF'],
    age_range: ['primary', 'secondary'],
    setting: ['one_to_one', 'home'],
    duration: '6 weeks',
    frequency: '3-5 times a week',
    session_length: '15 mins',
    complexity: 'low',
    staff_training_required: false,
    resources_needed: ['Books of choice'],
    cost_implications: 'None',
    key_components: ['Reading together', 'Signalling', 'Praise', 'Discussion'],
    fidelity_checklist: ['Synchronous reading', 'Immediate correction (4 second rule)'],
    progress_indicators: ['Reading age', 'Confidence'],
    expected_outcomes: ['Fluency', 'Enjoyment'],
    adaptations: ['Peer tutoring'],
    contraindications: ['None'],
    complementary_interventions: ['Phonics'],
    implementation_guide: 'Read together at the same pace. If child taps/signals, adult goes silent. If child struggles for 4 seconds, adult says word and they continue together.',
    parent_information: 'A simple way to read with your child that builds confidence and reduces frustration.',
    useful_links: ['https://www.dundee.ac.uk/esw/research/resources/pairedreading/'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['reading', 'literacy', 'parents', 'tier_1']
  }
);
...
// ========================================================================
// ADVANCED INCLUSION INTERVENTIONS (Ingested)
// ========================================================================
SOCIAL_EMOTIONAL_INTERVENTIONS.push(
  {
    id: 'ebsa-return-plan',
    name: 'EBSA Graduated Return Plan',
    category: 'social_emotional',
    subcategory: 'anxiety',
    description: "A structured, step-by-step plan to help students with Emotionally Based School Avoidance return to school. Focuses on reducing anxiety and building exposure.",
    targeted_needs: ['School refusal', 'High anxiety', 'Separation anxiety'],
    evidence_level: 'tier_3',
    research_sources: ['West Sussex EBSA Guidance', 'Anna Freud Centre'],
    age_range: ['all'],
    setting: ['home', 'mixed'],
    duration: '3-6 months',
    ...
    complexity: 'high',
    staff_training_required: true,
    resources_needed: ['Key worker', 'Safe space'],
    cost_implications: 'High staff ratio initially',
    key_components: ['Identify key worker', 'Safe arrival plan', 'Reduced timetable', 'Gradual exposure'],
    fidelity_checklist: ['Student voice included', 'Parents on board', 'Pace led by student anxiety levels'],
    progress_indicators: ['Attendance %', 'Anxiety ratings'],
    expected_outcomes: ['Return to full time education'],
    adaptations: ['Online learning transition'],
    contraindications: ['Forcing attendance (can increase trauma)'],
    complementary_interventions: ['CBT'],
    implementation_guide: "Start small (e.g., meeting key worker at gate). Build up time in school gradually. Ensure 'safe base' is available at all times.",
    parent_information: 'We are working with you to help your child feel safe enough to come back to school, one step at a time.',
    useful_links: ['https://www.annafreud.org'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['ebsa', 'attendance', 'anxiety', 'tier_3']
  },
  {
    id: 'ber-memory-box',
    name: 'Bereavement Memory Box',
    category: 'social_emotional',
    subcategory: 'bereavement',
    description: 'A therapeutic activity where a child creates a box of memories (photos, objects) to remember a loved one.',
    targeted_needs: ['Grief', 'Loss', 'Sadness'],
    evidence_level: 'tier_2',
    research_sources: ['Winston\'s Wish', 'Child Bereavement UK'],
    age_range: ['all'],
    setting: ['one_to_one'],
    ...
    complexity: 'medium',
    staff_training_required: true,
    resources_needed: ['Box', 'Art materials', 'Photos'],
    cost_implications: 'Small materials cost',
    key_components: ['Decorating box', 'Choosing items', 'Sharing memories'],
    fidelity_checklist: ['Child leads the process', 'Safe space provided'],
    progress_indicators: ['Ability to talk about the person'],
    expected_outcomes: ['Processing grief', 'Continuing bonds'],
    adaptations: ['Digital memory book'],
    contraindications: ['Recent trauma (may need specialist support)'],
    complementary_interventions: ['Seasons for Growth'],
    implementation_guide: 'Help the child decorate a special box. Ask them to bring in items that remind them of the person. Spend time talking about each item.',
    parent_information: 'We are helping your child keep happy memories safe.',
    useful_links: ['https://www.winstonswish.org'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['grief', 'bereavement', 'loss', 'tier_2']
  }
);

ACADEMIC_INTERVENTIONS.push(
  {
    id: 'da-mediated-learning',
    name: 'Mediated Learning (Dynamic Assessment)',
    category: 'academic',
    subcategory: 'cognition',
    description: "A teaching approach based on Vygotsky's ZPD. The adult actively mediates the learning task, focusing on 'how' to learn rather than just the answer.",
    targeted_needs: ['Stuck learners', 'Cognitive difficulties', 'Passive learners'],
    evidence_level: 'tier_2',
    research_sources: ['Feuerstein', 'Tzuriel'],
    age_range: ['all'],
    setting: ['one_to_one', 'small_group'],
    duration: 'Ongoing',
    ...
    complexity: 'high',
    staff_training_required: true,
    resources_needed: ['Task materials'],
    cost_implications: 'Training costs',
    key_components: ['Intentionality', 'Reciprocity', 'Meaning', 'Transcendence'],
    fidelity_checklist: ['Focus on process not product', 'Bridging to other contexts'],
    progress_indicators: ['Independence', 'Transfer of skills'],
    expected_outcomes: ['Cognitive modifiability', 'Better problem solving'],
    adaptations: ['N/A'],
    contraindications: ['None'],
    complementary_interventions: ['Metacognition'],
    implementation_guide: "Don't just give the answer. Ask: 'What do we need to do first?', 'Where have you seen this before?', 'Why is this important?'.",
    parent_information: 'We are teaching your child HOW to learn, so they can solve problems by themselves.',
    useful_links: ['https://www.dynamicassessment.co.uk'],
    created_at: '2025-12-11',
    updated_at: '2025-12-11',
    tags: ['cognition', 'learning_to_learn', 'dynamic_assessment', 'tier_2']
  }
);
