...
• Role-specific features based on your account type`,
  ...
  },
  {
    ...
    content: `📋 **Main Menu (Left Sidebar):**
...
• Recent searches are remembered`,
  ...
  // ===== ASSESSMENTS & ECCA =====
  {
    ...
    content: `📊 **ECCA (Educational Cognitive & Capability Assessment) Framework:**
...
• UK standardisation norms`,
  ...
  },
  {
    ...
    content: `📄 **Generating & Exporting Reports:**
...
• Add to EHCP documentation`,
  ...
  // ===== EHCP & STATUTORY =====
  {
    ...
    content: `📋 **Education, Health and Care Plan Module:**
...
3. Follow the guided workflow`,
  ...
  // ===== INTERVENTIONS =====
  {
    ...
    content: `🎯 **Evidence-Based Interventions Library:**
...
Your training hours are automatically logged for professional registration requirements.`,
  ...
  // ===== MARKETPLACE =====
  {
    ...
    content: `🔍 **Educational Psychologist Marketplace:**
...
5. Receive reports via platform`,
  ...
  // ===== ACCOUNT & SETTINGS =====
  {
    ...
    content: `⚙️ **Managing Your Account:**
...
Response time: Within 24 hours`,
  ...
  // ===== CASES & STUDENTS =====
  {
    ...
    content: `👤 **Case & Student Management:**
...
• Kinesthetic/practical learners`,
  ...
  },
  {
    ...
    content: `🤖 **EdPsych AI Assistant (This Chat!):**
...
For complex issues, contact: support@edpsychconnect.world`,
  ...
  // ===== VOICE COMMANDS =====
  {
    ...
    content: `🎙️ **Voice Command System:**
...
Registered in England & Wales`,
  ...
  // ===== CLASSROOM COCKPIT =====
  {
    ...
    content: `🎯 **Classroom Cockpit (Teachers):**
