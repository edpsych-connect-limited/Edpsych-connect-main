...
assertApprovedDrScottCasting({
  avatarId: AVATAR_ID,
  voiceId: VOICE_ID,
  context: 'scripts/generate-all-videos',
});
...
const MANUAL_SCRIPTS = {
  'platform-introduction': {
    ...
    script: `If you're watching this... you already know the truth. The system isn't just broken—it's a *maze*. A fragmented, chaotic maze of emails, spreadsheets, and missed deadlines. And who gets lost in that maze? ...The children.
