...
2. Visit `/landing-legacy` (if MDX route is added in a follow-up) **or** open `site/landing-legacy.html` directly.
3. Spot-check images resolve from `/images/legacy/**`.
4. Confirm `.gitignore` contains `_imports/*.zip`.
