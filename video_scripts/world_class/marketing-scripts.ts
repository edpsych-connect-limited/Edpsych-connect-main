/**
 * World-Class Video Scripts for EdPsych Connect World
 * 
 * STYLE GUIDE:
 * - Conversational, warm, like talking to a trusted colleague
 * - Rich analogies that make complex concepts click
...
export const MARKETING_VIDEOS = {
  // ============================================================================
  // VIDEO 1: PLATFORM INTRODUCTION (2 minutes)
  // The welcome video - first thing users see during onboarding
  // ============================================================================
...
Let's get started.`
  ...
  // ============================================================================
  // VIDEO 2: DATA AUTONOMY & TRUST (90 seconds)
  // "See The Magic" section - explain BYOD/data security
  // ============================================================================
  dataAutonomy: {
    id: 'data-autonomy',
...
That's the EdPsych Connect difference. Your data. Your control. Always.`
  ...
  // ============================================================================
  // VIDEO 3: NO CHILD LEFT BEHIND (90 seconds)
  // "See The Magic" section - explain differentiation engine
  // ============================================================================
  noChildLeftBehind: {
...
No child left behind isn't just our name. It's our promise.`
  ...
  // ============================================================================
  // VIDEO 4: GAMIFICATION INTEGRITY (90 seconds)
  // "See The Magic" section - explain Battle Royale learning
  // ============================================================================
  gamificationIntegrity: {
...
export default MARKETING_VIDEOS;
