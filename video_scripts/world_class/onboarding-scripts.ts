/**
 * EdPsych Connect World - Onboarding Video Scripts
 * World Class Edition - Storytelling Format
 * 
 * Style: Warm, conversational, UK English, rich analogies
 * Character: Welcoming mentor who genuinely cares about your success
 */
...
export default ONBOARDING_SCRIPTS;
